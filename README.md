...
./scripts/check-package.sh dist/TransferCenter-0.1.4.dynamiclakeplugin.zip
```
...
The archive is created at `dist/TransferCenter-0.1.4.dynamiclakeplugin.zip`. Releases are not automatically published.
